<x-app-layout>
    @include('wali-santri.modal.create')
    @include('wali-santri.modal.show')
    @include('wali-santri.modal.edit')
    @push('js')
        <script>
            // show
            $('.show-data').on('click',function() {
                ...
                $.ajax({
                    ...
                    success: (res) => {
                        ...
                        $('#show-modal #nama_lengkap').val(res.nama);
                        $('#show-modal #email').val(res.email);
                        $('#show-modal #no_telp').val(res.no_telp);
                        $('#show-modal #alamat').val(res.alamat);
            ...
            $('.edit-data').on('click',function() {
                ...
                $.ajax({
                    ...
                    success: (res) => {
                        console.log(res);
                        // Assuming you have a modal with an ID 'show-modal'
                        $('#edit-modal #nama_lengkap').val(res.nama);
                        $('#edit-modal #id').val(res.id);
                        $('#edit-modal #email').val(res.email);
                        $('#edit-modal #no_telp').val(res.no_telp);
                        $('#edit-modal #alamat').val(res.alamat);
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            ...
                                            <div id="{{ $item->id }}-dropdown" class="hidden z-50 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                ...
                                                <div class="py-1">
                                                    <a href="{{ route('wali-santri.destroy', $item->id) }}" data-confirm-delete="true" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
