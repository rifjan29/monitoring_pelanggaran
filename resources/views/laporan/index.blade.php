                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">KODE LAPORAN</th>
                                    <th scope="col" class="px-4 py-3">Tanggal Pelaporan</th>
                            ...
                            <tbody>
                                @forelse ($laporan as $item)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ ucwords($item->kode_laporan) }}</th>
                                        <td class="px-4 py-3">{{ \Carbon\Carbon::parse($item->tanggal)->format('d F Y') }}</td>
                                        <td class="px-4 py-3 flex items-center justify-end align-baseline">
                                            <a href="{{ route('laporan.detail',$item->id) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                <svg class="w-3.5 h-3.5 me-2 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
