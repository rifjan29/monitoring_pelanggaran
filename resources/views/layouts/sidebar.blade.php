    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
       <ul class="space-y-2 font-medium">
            ...
            <li class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-100 dark:border-gray-700">
                <a href="{{ route('santri.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-100 dark:border-gray-700">
                <a href="{{ route('wali-santri.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-semibold">Wali Santri</span>
                </a>
            </li>
            <li class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-100 dark:border-gray-700">
                <a href="{{ route('asrama.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-4 h-4 text-gray-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-semibold">Asrama</span>
                </a>
            </li>
            <li class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-100 dark:border-gray-700">
                <a href="{{ route('user.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-4 h-4 text-gray-400 dark:text-white" aria-hidden="true" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-semibold">Data User</span>
                </a>
            </li>
            <li class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-100 dark:border-gray-700">
                <a href="{{ route('pelanggaran-sekolah.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">

                    <svg class="w-4 h-4 text-gray-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-semibold">Pelanggaran Sekolah</span>
                </a>
            </li>
            <li class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-100 dark:border-gray-700">
                <a href="{{ route('pelanggaran-pondok.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-semibold">Pelanggaran Pondok</span>
                </a>
            </li>
            <li class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-100 dark:border-gray-700">
                <a href="{{ route('laporan.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-4 h-4 text-gray-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
