                    ...
                    <div class="grid gap-4 grid-cols-2 sm:grid-cols-2 sm:gap-6 mb-5">
                        ...
                        <div class="">
                            ...
                            <div class="relative max-w-sm">
                                ...
                                <input datepicker type="text" readonly name="tanggal_lahir" id="tanggal_lahir" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select id="sekolah" disabled name="sekolah" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select id="asrama" disabled name="asrama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="asrama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status Sekolah</label>
                            <div id="status_sekolah"></div>
                        </div>
                        <div>
                            <label for="asrama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status Pondok</label>
                            <div id="status_pondok"></div>
                        </div>
                        <div class="col-span-2 sm:col-span-2">
                            <label for="wali_santri" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wali Santri</label>
                            <select id="wali_santri" disabled name="wali_santri" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="col-span-2 sm:col-span-2">
                            ...
                            <textarea id="alamat" readonly name="alamat" rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukkan Alamat"></textarea>
                        </div>
                    </div>
                </div>
            </div>
