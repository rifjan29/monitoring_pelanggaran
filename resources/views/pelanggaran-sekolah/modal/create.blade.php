        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <div class="grid gap-4 grid-cols-2 sm:grid-cols-2 sm:gap-6 mb-5">
                    ...
                    <div class="col-span-2 sm:col-span-2">
                        <label for="wali_santri" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Foto Bukti</label>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="foto_bukti_pelanggaran_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
                    </div>
