        ...
        <div class="p-4">
            <div id="alert-additional-content-1" class="p-4 mb-4 text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg  font-bold">Selamat Datang Di Sistem Monitoring Pelanggaran Santri</h3>
                </div>
           ...
           <div class="grid grid-cols-3 gap-4 mb-4 place-items-stretch">
               <div class="h-32 rounded bg-gray-50 dark:bg-gray-800 p-5">
                ...
                <div class="h-32 rounded bg-gray-50 dark:bg-gray-800 p-5">
                    <div class="flex justify-between flex-row items-center px-4">
                        <div class="space-y-2">
                            <span class="text-sm font-medium text-gray-400 dark:text-gray-400">Total Wali Santri</span>
                            <h2 class="text-4xl font-bold dark:text-white">{{ $wali_santri_count }}</h2>
                        </div>
